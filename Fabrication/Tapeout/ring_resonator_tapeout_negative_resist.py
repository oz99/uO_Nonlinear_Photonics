...
ring1 = c << gf.components.ring_single(gap=0.2, radius=10.0, length_x=4.0, length_y=0.6)
ring2 = c << gf.components.ring_single(gap=0.2, radius=10.0, length_x=4.0, length_y=0.6)
ring2.move((100, 100))
route = gf.routing.route_single(ring1.ports["o2"], ring2.ports["o1"], radius=10, width=0.5)
