...
for i in range(num_rows):
    ...
    prox_corr_row_file = gf.read.import_gds('c:\\Users\\test\\waveguide_tapeout_pos_resist.gds', read_metadata=True)
...
##########################################
array_component.name = "WG_dose_test"
# Show the complete array of components
array_component.show()

gdspath = array_component.write_gds(f"WG_dose_test.gds", precision=1e-9, unit=1e-9,with_metadata=True)
