...
def main(args):
    ...
    c = gf.Component("ring_tapeout_with_taper_neg_resist")
    ...
    for i in range(0, steps+1):
        ...
        # ring0.connect("o2", destination=ring["o1"])
        ...
        input_coupler1.connect("o1", destination=b["o2"])
        
        input_coupler2.connect("o1", destination=f["o2"])
        
        output_coupler1.connect("o1", destination=d["o2"])
    ...
    gdspath = c.write_gds("ring_tapeout_neg_resist.gds", precision=1e-9, unit=1e-6,with_metadata=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--length1', type=int, default=30, help='Length of the waveguide')
