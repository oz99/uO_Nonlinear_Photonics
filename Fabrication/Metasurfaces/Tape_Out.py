...
meta = gf.read.import_gds('c:\\UO\\Git_dump\\uO_Nonlinear_Photonics\\Fabrication\\Metasurfaces\\metasurface_v1_v2.gds')
...
my_gds_ref.move((50, 50))  # Position of my_gds component, change as needed
