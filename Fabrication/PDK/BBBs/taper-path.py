...
grating = ComponentAlongPath(
    ...
    # component= gf.kdb.DPolygon([(-8, -6), (6, 8), (7, 17), (9, 5)], spacing=0.515, padding=1

# Instead of a rectangle make a prism with a triangular cross-section
    component= gf.c.prism(size=(0.315, 1), centered=True), spacing=0.515, padding=1                                       
