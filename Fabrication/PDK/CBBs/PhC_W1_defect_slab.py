...
W1_b.move([0, -((2*(a+hole_radius)))]) # Tyically the width of the defect slab is 2 x lattice cst
...
c_with_pins.write_gds("W1_defect_PhC_{}_rows_a={}um.gds".format(row_length,a))
